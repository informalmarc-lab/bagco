...
export default function Footer() {
  return (
    <footer className="border-t border-amber-200 bg-slate-950 text-slate-300">
      <div className="section-container py-14">
        <div className="mb-10 rounded-2xl border border-slate-800 bg-slate-900 p-6">
          <h2 className="text-2xl font-black text-white">Email Us for Pricing</h2>
          ...
          <div className="mt-4 flex flex-wrap items-center gap-3">
            ...
            <span className="text-sm text-slate-400">Suggested subject: {subjectTemplate}</span>
          </div>
        </div>

        <div className="grid gap-10 md:grid-cols-4">
          <div>
            <h3 className="text-2xl font-black text-white">Bag Supply Co</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/manufacturing" className="text-slate-400 transition-colors hover:text-white">
                  Manufacturing
                </Link>
              </li>
              <li>
