...
export const metadata: Metadata = {
  title: 'Contact',
  description: 'Contact Bud Bags for dispensary paper bag pricing, stock coverage, custom print quotes, and reorder support.',
}
  ...
  return (
    <section className="container-page grid gap-8 py-10 lg:grid-cols-[0.65fr_0.35fr]">
      ...
      <aside className="card h-fit p-5 md:p-6">
        <h2 className="text-2xl font-black text-leaf">Talk through the bag situation at your store.</h2>
