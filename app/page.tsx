        ...
        <div className="container mx-auto px-4 py-28 md:py-40 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                href="/catalog" 
                className="bg-white text-primary-700 px-10 py-4 rounded-xl font-semibold hover:bg-primary-50 transition-all shadow-xl hover:shadow-2xl hover:scale-105 transform duration-300 flex items-center justify-center gap-2"
              >
              ...
              <Link 
                href="/contact" 
                className="bg-primary-500 text-white px-10 py-4 rounded-xl font-semibold hover:bg-primary-400 transition-all shadow-xl hover:shadow-2xl hover:scale-105 transform duration-300 border-2 border-white/30 flex items-center justify-center gap-2"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
