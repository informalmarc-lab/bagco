...
export async function generateQuotePdf(record: AdminQuoteRecord): Promise<Uint8Array> {
  ...
  y -= 13
  page.drawText('912 Houston Drive', { x: MARGIN, y, size: 9, font: fontRegular, color: BLACK })
  y -= 12
  page.drawText('Monroe, NC 28110', { x: MARGIN, y, size: 9, font: fontRegular, color: BLACK })
  y -= 12
  ...
  page.drawText('bagsupplyco.com  |  912 Houston Drive, Monroe, NC 28110  |  (704) 862-9256', {
    x: MARGIN,
    y: footerY,
    size: 7.5,
    font: fontRegular,
